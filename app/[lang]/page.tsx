  ...
  return (
    <main id="main" className="flex min-h-screen flex-col items-center p-24 gap-y-6">
      ...
      <div className="flex flex-col items-center text-center my-6">
        ...
        <div className="grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left md:grid-cols-3">
          <a
            href="https://salvatorericcardi.github.io/alpaca-generator"
            className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 md:h-60 lg:h-80"
          >
          ...
          <a
            href="https://salvatorericcardi.github.io/contact-form"
            className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 md:h-60 lg:h-80"
          >
            <h2 className="mb-3 text-2xl font-semibold">
              {translation.project2.title}&nbsp;
              <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
                &rarr;
              </span>
            </h2>
            ...
            <p className="my-0 mx-auto max-w-[30ch] text-sm opacity-50">
              {translation.project2.description}
            </p>
          </a>
        </div>
      </div>
